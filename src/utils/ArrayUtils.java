...
public class ArrayUtils {
    ...
    */
    ...
    public static int[] readIntArrayFromConsole(String arrName) {
        return readArrayFromConsole(arrName, ru.vsu.cs.vvp2022.burlakovaAV.utils.ArrayUtils::toIntArray);
    }

    public static double[] readDoubleArrayFromConsole(String arrName) {
        return readArrayFromConsole(arrName, ru.vsu.cs.vvp2022.burlakovaAV.utils.ArrayUtils::toDoubleArray);
    }
    */
    ...
    public static int[] createRandomIntArray(int length, int maxValue) {
        return createRandomIntArray(length, -100, maxValue);
    }
